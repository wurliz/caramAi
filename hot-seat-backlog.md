...
**v0.2 · Technology Proof of Concept**
...
1. [Epic 1 — 3D Room & Investigation](#epic-1--3d-room--investigation)
2. [Epic 2 — Voice Input Pipeline](#epic-2--voice-input-pipeline)
3. [Epic 3 — AI Hostage Taker Character](#epic-3--ai-hostage-taker-character)
...
## Epic 1 — 3D Room & Investigation

**Goal:** Give the player a believable, walkable crime-scene room they can freely explore to gather evidence and context.
...
**Priority:** Must have · **Estimate:** 3 pts
...
**Priority:** Must have · **Estimate:** 2 pts
...
**Priority:** Must have · **Estimate:** 8 pts
...
**Priority:** Should have · **Estimate:** 3 pts
...
**Priority:** Should have · **Estimate:** 2 pts

---

## Epic 2 — Voice Input Pipeline

**Goal:** Let the player negotiate using their actual voice, with real-time transcription feeding into the AI conversation loop.
...
**Priority:** Must have · **Estimate:** 5 pts
...
## Epic 3 — AI Hostage Taker Character

**Goal:** Create a believable, emotionally responsive AI character who remembers the conversation, reacts to evidence the player demonstrates knowledge of, and shifts behaviour based on tension state.
...
**Priority:** Must have · **Estimate:** 3 pts (spike)
...
**Goal:** Communicate tension state entirely through environmental cues once the explicit meter is removed post-v1. V1 ships with a visible meter for calibration.

---

### US-501 — Tension meter (v1, debug/calibration)

> **As a developer,** I want a visible numeric or bar tension meter during v1, **so that** we can calibrate environmental feedback signals before removing the explicit meter.
...
**Priority:** Must have (v1 only) · **Estimate:** 2 pts
...
### US-504 — Tension meter removal (post-v1 milestone)
...
**Priority:** Won't have (v1) · **Estimate:** 5 pts
...
**Goal:** Deliver multiple ending states driven by accumulated tension, conversation quality, and evidence gathered — weighted equally between the physical and conversational strands.
...
**Priority:** Could have · **Estimate:** 5 pts
...
**Priority:** Should have · **Estimate:** 5 pts
...
**Priority:** Must have · **Estimate:** 5 pts (spike)
...
| Epic | Stories | Must Have | Should Have | Could Have | Won't Have (v1) |
|------|---------|-----------|-------------|------------|-----------------|
| E1 — Room & Investigation | 6 | 3 | 2 | 0 | 0 |
| E2 — Voice Input | 5 | 4 | 1 | 0 | 0 |
| E3 — AI Character | 7 | 5 | 1 | 0 | 0 |
| E4 — CCTV Interface | 4 | 4 | 0 | 0 | 0 |
| E5 — Tension & Feedback | 4 | 1 | 2 | 0 | 1 |
| E6 — Clue System | 5 | 4 | 1 | 0 | 0 |
...
- **Stalemate feasibility** — Is the stalemate outcome worth the design and implementation effort for a 2-person team at PoC stage? Recommend deferring until scenario 1 win/lose are solid.
...
- **Scenario 2 content** — Deprioritised for PoC; config system (US-1005) ensures it can be added without code debt.

---

*Document version: 0.2 · Last updated: April 2026*
